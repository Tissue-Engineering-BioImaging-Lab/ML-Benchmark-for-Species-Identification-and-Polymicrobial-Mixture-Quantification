# Train + run a Clean Train Noise Test notebook end-to-end on the GPU with no browser, saving
# all outputs (plots, metrics, and model_predictions.csv) back into this folder.
#
